...
function drawCalender(firstDay, lastDate, date, year, month){
    document.write("firstDay:"+firstDay+"date:"+date+"year:"+year+ "month:"+month);
    var text ="<center>";

    text += "<table border>";
    text += "<th colspan='7' bgColor='yellow'>";       //bgColor : 백그라운드 컬러
    ...
    var rowSize = Math.ceil((lastDate+firstDay-1)/7);    //row가 몇개인지 알고자 하는 것
